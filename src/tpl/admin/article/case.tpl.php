...
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
            ...
            <a class="btn btn-primary radius"  href="/admin/Article/article_add?parent_id=2"><i class="Hui-iconfont">&#xe600;</i> 添加案例</a>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="f-14 td-manage">
                    <a style="text-decoration:none" class="ml-5"  href="/admin/Article/edit?id=<?php echo $item['id'];?>&parent_id=<?php echo $item['parent_id'];?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
