...
<script type="text/javascript">
    ...
    {/if}
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 资讯管理 <span class="c-gray en">&gt;</span> 需求审核 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
            ...
            <a class="btn btn-primary radius"  href="/admin/Article/demand_article_add"><i class="Hui-iconfont">&#xe600;
                </i> 添加资讯</a>
