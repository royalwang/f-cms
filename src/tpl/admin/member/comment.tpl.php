    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <a title="查看" href="javascript:;" onclick="member_edit('管理员查看','/admin/Member/edit_comment?a_id=<{$vo.id}>','<{$vo.id}>','800','400')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>
