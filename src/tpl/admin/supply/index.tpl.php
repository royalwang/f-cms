    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <a style="text-decoration:none" class="ml-5" onClick="review('审核','/admin/Supply/review?gq_id={$vo['gq_id']}','{$vo['gq_id']}','600','270')" href="javascript:;" title="审核"><i class="Hui-iconfont">&#xe61d;</i></a>
                    <a title="编辑" href="javascript:;" onclick="supply_edit('编辑供求信息','/admin/Supply/edit?gq_id={$vo['gq_id']}','{$vo['gq_id']}','600','800')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    {if $gid <= 5}
                    <a style="text-decoration:none" class="ml-5" onClick="set_top('置顶','/admin/Supply/settop?gq_id={$vo['gq_id']}','{$vo['gq_id']}','600','270')" href="javascript:;" title="置顶"><i class="Hui-iconfont">&#xe6dc;</i></a>
                    <a title="删除" href="javascript:;" onclick="supply_del(this,'{$vo['gq_id']}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                    {/if}
                </td>
            </tr>
            {/foreach}
