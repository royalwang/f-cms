    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <a style="text-decoration:none" class="ml-5" onClick="review('审核','/admin/Supply/review?gq_id=<?php echo$vo['gq_id'];?>,'<?php echo $vo['gq_id'];?>','600','270')" href="javascript:;" title="审核"><i class="Hui-iconfont">&#xe61d;</i></a>
